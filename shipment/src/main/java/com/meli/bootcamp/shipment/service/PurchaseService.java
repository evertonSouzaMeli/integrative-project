...
import com.meli.bootcamp.shipment.dto.response.PurchaseResponse;
...
public class PurchaseService {
    ...
    public Cart addProducts(String buyerCode, List<ProductRequest> productRequestList) {
        ...
        cart.setTotal(new BigDecimal(String.valueOf(cart.getTotal().add(BigDecimal.valueOf(total.doubleValue())))).setScale(2, RoundingMode.HALF_EVEN));
        buyer.setCart(cart);
        buyerRepository.save(buyer);
